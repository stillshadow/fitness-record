...
(() => {
  ...
  const boot=()=>{load('ui-v5.js?v=39','ui-v5');load('ui-v3.js?v=39','ui-v3');load('training-plan-v2.js?v=39','training-plan-v2');load('ui-v2.js?v=39','ui-v2');load('training-session.js?v=39','training-session');load('ui-v4.js?v=39','ui-v4')};
