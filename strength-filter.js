...
(() => {
  ...
  const boot=()=>{load('ui-v3.js?v=37','ui-v3');load('training-plan-v2.js?v=37','training-plan-v2');load('ui-v2.js?v=37','ui-v2');load('training-session.js?v=37','training-session');load('ui-v4.js?v=38','ui-v4')};
