const CACHE='chibianying-fitness-v1-37';
const ASSETS=['./','index.html','manifest.json','cloud-config.js','food-system.js','training-system.js','history-system.js','set-logger.js','strength-filter.js','training-plan-v2.js','training-session.js','ui-v2.js','ui-v2.css','ui-v3.js','update.html','icon-192.png','icon-512.png'];
